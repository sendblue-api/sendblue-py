...
class TestSendblueAPI:
    client = SendblueAPI(base_url=base_url, api_key=api_key, api_secret=api_secret, _strict_response_validation=True)
...
class TestAsyncSendblueAPI:
    ...
    def test_base_url_trailing_slash(self, client: AsyncSendblueAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncSendblueAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncSendblueAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    def test_get_platform(self) -> None:
        ...
        from sendblue_api._base_client import get_platform
